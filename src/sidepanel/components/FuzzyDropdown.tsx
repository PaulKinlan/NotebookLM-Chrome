 ...
 * ```
 */
export function FuzzyDropdown(props: FuzzyDropdownProps) {
...
function RenderGroupedOptions({ grouped, highlightedIndex, inputValue, onSelect }: RenderGroupedOptionsProps): ComponentChildren {
  let globalIndex = 0
