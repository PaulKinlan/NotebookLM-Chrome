...
export function ChatTab(props: ChatTabProps) {
  const { active, onQuery, onClearChat, onRegenerateSummary, onAddCurrentTab } = props;
  ...
  return (
    <section id="tab-chat" className={`tab-content ${active ? 'active' : ''}`}>
      ...
      <h3 className="section-title">
        ...
        <a href="#" id="manage-sources" className="link">
          Manage
        </a>
      </h3>
      <div id="active-sources" className="sources-list compact"></div>

      <button id="add-page-btn" className="btn btn-outline btn-small" onClick={onAddCurrentTab}>
        <svg
          width="14"
          height="14"
          viewBox="0 0 24 24"
      ...
      <div className="chat-section">
        <div className="chat-header">
          ...
          <button id="clear-chat-btn" className="btn btn-small btn-outline" title="Clear chat history" onClick={onClearChat}>
            Clear
          </button>
        </div>
      ...
      <div className="query-box">
        ...
        <input type="text" id="query-input" placeholder="Ask a question about your sources..." />
        <button id="query-btn" className="icon-btn btn-primary" onClick={onQuery}>
          <svg
            width="16"
            height="16"
            viewBox="0 0 24 24"
      ...
      <p className="helper-text" id="chat-status">
