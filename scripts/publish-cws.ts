...
const extensionId = assertEnv(process.env.CWS_EXTENSION_ID, "CWS_EXTENSION_ID");
const publisherId = assertEnv(process.env.CWS_PUBLISHER_ID, "CWS_PUBLISHER_ID");
const clientId = assertEnv(process.env.CWS_CLIENT_ID, "CWS_CLIENT_ID");
const clientSecret = assertEnv(process.env.CWS_CLIENT_SECRET, "CWS_CLIENT_SECRET");
const refreshToken = assertEnv(process.env.CWS_REFRESH_TOKEN, "CWS_REFRESH_TOKEN");
